<footer class="mt-10 bg-blue-900 text-white rounded-tl-2xl rounded-tr-2xl footer">
    <div class="container mx-auto py-8 px-4">
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/3 mb-6">
                <h1 class="text-lg text-white font-semibold">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('assets/logo/fit_circle.png')); ?>" alt="FIT TDC" class="w-[50px] h-[50px] rounded-full">
                    </a>
                </h1>
            ...
            <div class="w-full md:w-1/3 mb-6 text-center">
                ...
                <ul class="mt-2">
                    <li><a href="<?php echo e(route('dashboard')); ?>" class="hover:text-yellow-300">Trang chủ</a></li>
                    <li><a href="<?php echo e(route('events.index')); ?>" class="hover:text-yellow-300">Sự kiện</a></li>
                    <li><a href="<?php echo e(route('statisticals.index')); ?>" class="hover:text-yellow-300">Thống kê</a></li>
                </ul>
            </div>
            <!-- Liên hệ -->
...
</footer><?php /**PATH /var/www/tdc-event-management/resources/views/components/footer.blade.php ENDPATH**/ ?>