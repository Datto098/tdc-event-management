...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        async function createSliderItems() {
            const url = "<?php echo e(route('events.get.featured')); ?>";
            ...
            try {
                if (result.data.length === 0) {
                    ...
                    result.data.forEach(event => {
                        ...
                        let route = "<?php echo e(route('events.detail', ':id')); ?>".replace(':id', event.id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tdc-event-management/resources/views/home.blade.php ENDPATH**/ ?>